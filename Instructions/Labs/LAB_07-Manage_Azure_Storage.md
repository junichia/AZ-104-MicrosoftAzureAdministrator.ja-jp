...
1. **冗長性** ドロップダウン リストから **[ローカル冗長ストレージ (LRS)]** を選択して、変更を保存します。

1. **場所** にプライマリの場所だけがあることに注意してください。

1. ストレージ アカウントの **設定** にある **[構成]** ブレードを表示し、BLOBのアクセスレベルを **[クール]** に設定して、変更を保存します。
...
1. 新しく作成したファイル共有をクリックし、**[接続]** をクリックします。**Show Scripts** をクリックし、接続用のスクリプトを表示してクリップボードにコピーします。
