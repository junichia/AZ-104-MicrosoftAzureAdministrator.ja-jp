...
1. 前のステップでメモした[リソース グループ] の名前のブレードで、**[タグ]** の横にある **[編集]** をクリックして新しいタグを作成します。
...
1. 前のタスクで特定した[リソース グループ]名のブレードで、**[+ 作成]** をクリックしてから「**ストレージ アカウント**」と検索し、**[+ 作成]** をクリックします。 
...
1. 新しいストレージ アカウントがプロビジョニングされたら、**[リソースに移動]** ボタンをクリックし、新しく作成したストレージ アカウントの **[概要]** ブレードで、値 **Infrastructure ** のタグ **Role** が自動的にリソースに割り当てられていること確認します。
